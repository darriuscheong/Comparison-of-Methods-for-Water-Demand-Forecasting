...
# show model summary
print('Optimized Multi ANN v4')
best_model.summary()

#Get opt learning rate
from keras import backend as K
learning_rate = K.eval(best_model.optimizer.lr)
dropout_rate = best_model.get_layer(index=3).get_config()['rate']
...
for it in range(11,21):
    #Train Model
    checkpoint_path = './checkpoints2/m_ANNv4_'+str(it)
    ...
    print('m_ANNv4_'+str(it),end=',')
    for i in score_arr:
        print(i,end=',')
    print(train_time)

    #Save excel
    excel_name = 'm_ANNv4_'+str(it)+'.xlsx'
